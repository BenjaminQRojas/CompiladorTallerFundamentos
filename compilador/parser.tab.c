...
{
       0,     0,     3,     4,     7,    13,    18,    26,    32,    38,
      44,    48,    50,    53,    55,    57,    61,    65,    69,    73,
      77,    81,    85,    89,    93,    97
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      33,    25,    31,     7,    31,    -1,     6,    24,    33,    25,
      31,    -1,     8,    24,    33,    25,    23,    -1,     5,    24,
      33,    25,    31,    -1,    26,    32,    27,    -1,    30,    -1,
      32,    30,    -1,     4,    -1,     3,    -1,    33,    19,    33,
      -1,    33,    20,    33,    -1,    33,    21,    33,    -1,    33,
      22,    33,    -1,    33,    12,    33,    -1,    33,    13,    33,
      -1,    33,    14,    33,    -1,    33,    15,    33,    -1,    33,
      16,    33,    -1,    33,    17,    33,    -1,    24,    33,    25,
      -1
};
...
{
       0,   280,   280,   281,   289,   290,   291,   292,   293,   294,
     298,   302,   309,   319,   320,   321,   322,   323,   324,   325,
...
/* Line 1455 of yacc.c  */
#line 280 "parser.y"
    { /* No AST is created for an empty program */ ;}
    break;
...
#line 281 "parser.y"
    { 
       // printf("Ejecutando una linea del programa\n");  Debugging
        execute_ast((yyvsp[(2) - (2)].node)); 
        free_ast((yyvsp[(2) - (2)].node)); 
    ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 298 "parser.y"
    { (yyval.node) = create_block_node((yyvsp[(2) - (3)].node)->block.statements, (yyvsp[(2) - (3)].node)->block.statement_count); ;}
    break;
...
#line 302 "parser.y"
    { 
        ...
        (yyval.node)->block.statements[0] = (yyvsp[(1) - (1)].node);
...
#line 309 "parser.y"
    { 
        int count = (yyvsp[(1) - (2)].node)->block.statement_count;
        (yyvsp[(1) - (2)].node)->block.statements = (ASTNode **)realloc((yyvsp[(1) - (2)].node)->block.statements, sizeof(ASTNode *) * (count + 1));
        (yyvsp[(1) - (2)].node)->block.statements[count] = (yyvsp[(2) - (2)].node);
        (yyvsp[(1) - (2)].node)->block.statement_count++;
